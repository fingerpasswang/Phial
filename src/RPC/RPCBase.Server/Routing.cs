...
namespace RPCBase
{
    public class RoutingRule
    {
        ...
        public class AmqpRoutingRule
        {
            ...
            {
                return DelegateRoutingKey != null ? DelegateRoutingKey(DistrictsName, uuid!=null?new Guid(uuid).ToString():"") : "";
            }
        ...
        {
            /// <summary>
            /// DistrictsName -> ServicePath;
            /// </summary>
            public MetaInfoFunc<string, string> ServicePath { private get; set; }
            ...
            {
                return string.Format("/{0}", DistrictsName);
            }

            public static string GetServiceSeqRoot()
            {
                return string.Format("/{0}", DistrictsName);
            }
        }
